...
export default class Home extends React.Component {
    render () {
        return <div>
          <h1>Introduction</h1>
          <p>Built upon the isomorphic principal; rendering the same HTML server side and rendering pages client side to increase performance. It uses <a href="https://facebook.github.io/react/">React</a> for templating with <a href="https://fezvrasta.github.io/bootstrap-material-design/">Material Design for Bootstrap</a> and <a href="http://sass-lang.com/">Sass</a> for CSS styling.</p>
          <section>
            <h4>Demos</h4>
            <ul>
              <li><Link to="/forms">Sample form</Link></li>
              <li><Link to="/tables">Sample table</Link></li>
              <li><a href="index_existing.html">Using with an existing project</a></li>
            </ul>
          </section>
          <section>
          <h4>Created with</h4>
